...
Đây là "cầu nối" giữa tài liệu thiết kế (OVERVIEW / detail design / prototype / Figma) và Spec Kit.
...
- Input sources (đường dẫn docs + prototype/Figma)
...
File này commit vào Git — bằng chứng agent đã hiểu đúng tài liệu thiết kế tại thời điểm sinh spec.
